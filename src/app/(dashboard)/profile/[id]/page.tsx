...
import { Trophy, Skull, Target, Medal, ArrowLeft, Copy, Check } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <p className="text-naval-text-secondary mb-4">Não foi possível localizar os dados deste comandante.</p>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div className="flex items-center gap-5">
                <div className="w-24 h-24 rounded-full overflow-hidden border-[3px] border-cyan-400 shadow-lg shadow-cyan-500/20 flex-shrink-0">
                  <Image src="/mortyy.jpg" alt="Avatar" width={96} height={96} className="object-cover w-full h-full" />
                </div>

                <div>
                  <h2 className="text-2xl font-bold text-white mb-3">{profile.username}</h2>
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-cyan-500/15 border border-cyan-500/30">
                      ...
                      <span className="text-sm font-semibold text-cyan-400">{rank.title}</span>
                    </div>
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-800 border border-slate-700">
                      <span className="text-xs text-slate-400 font-mono">ID: {userId.substring(0, 8)}...</span>
                      <button
              ...
              <div className="flex flex-row items-center gap-8 px-2 md:px-6 w-full md:w-auto justify-around md:justify-end border-t md:border-t-0 border-slate-800 pt-4 md:pt-0">
                <div className="text-center">
                  <p className="text-3xl font-bold text-amber-400">{profile.rankPoints}</p>
              ...
              <div>
                <CardTitle className="flex items-center gap-3 text-white">
                  ...
                  <div>
                    ...
                    {unlockedCount} de {medals.length} medalhas obtidas por este comandante
                  </span>
                  </div>
                </CardTitle>
              </div>
