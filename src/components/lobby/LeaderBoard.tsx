...
const PlayerRow: React.FC<PlayerRowProps> = ({
  ...
  return (
      <div
          ...
          className={`flex p-2 gap-3 m-auto rounded-2xl border cursor-pointer transition-transform hover:scale-[1.02] hover:shadow-md ${ // <-- Efeitos de hover e cursor
              isTopThree
                  ? "bg-naval-action/10 border-naval-action/30 shadow-[inset_0_0_10px_rgba(var(--naval-action-rgb),0.1)]"
                  : "bg-naval-bg border-naval-border hover:border-naval-action/50 hover:bg-slate-800/80"
          }`}
      >
        {/* Rank Position Badge */}
        <div
